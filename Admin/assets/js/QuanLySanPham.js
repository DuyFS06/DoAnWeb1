...
QLSP_formThemSP.addEventListener("submit", function(e) {
    ...
    const spMoi = {
        ...
        importPrice: parseFloat(document.getElementById("QLSP_spImportPrice").value) || 0,
        priceValue: 0,
        quantity: 0,
...
document
    ...
    .addEventListener("click", function() {
        ...
        dsSanPham[index] = {
            ...
            importPrice: parseFloat(document.getElementById("QLSP_editImportPrice").value) || 0,
...
function loadCategoriesIntoDropdowns() {
    ...
    try {
        ...
        dropdowns.forEach(id => {
            ...
            const activeCategories = categories.filter(cat => cat && cat.status === 'active');
            ...
            const stillExists = activeCategories.some(cat => cat.name === currentValue);
